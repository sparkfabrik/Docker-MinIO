...
| `MINIO_TEMP_PORT`          | The port used by the temporary server during the initialization. It must differ from `MINIO_PORT`, otherwise the health check reports the container healthy too early.   | `19000`                             |
| `MINIO_TEMP_CONSOLE_PORT`  | The console port used by the temporary server during the initialization.                                                                                                | `19001`                             |
